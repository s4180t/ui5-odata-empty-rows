		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5odataemptyrows-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5odataemptyrows-display": {
								"semanticObject": "ui5odataemptyrows",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5odataemptyrows",
									"url": sap.ui.require.toUrl("ui5odataemptyrows")
								}
							}
						}
					}
